    ...
    return (
      <>
        ...
        >
          ...
          <input
            className={`flex w-full flex-shrink-0 items-center rounded-2xl ${errorMessage ? `border-2 border-purple-100` : `border-[1px] border-gray-300`} bg-white px-5 py-[0.88rem] text-gray-800`}
            ref={ref}
            {...props}
          />
          {errorMessage && (
