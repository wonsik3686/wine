...
function Chip({
  ...
  return (
    <button
      className={clsx(
        'rounded-full px-[18px] py-[10px] text-base font-medium',
        {
          'border-[1px] border-purple-100 bg-purple-100 text-white': selected,
          'border-[1px] border-gray-300 bg-white': !selected,
